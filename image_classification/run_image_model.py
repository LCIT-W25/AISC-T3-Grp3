...
transfer_learning_model = tf.keras.models.load_model(TRANSFER_LEARNING_MODEL_PATH)

# Function to preprocess image
def preprocess_image(img_path, target_size=(224, 224)):
    img = image.load_img(img_path, target_size=target_size)  # Modify target_size based on your model
...
def predict_image_class(image_path, model_type="cnn"):
    ...
    if model_type == "cnn":
        ...
        raise ValueError("Invalid model type. Choose 'cnn' or 'transfer_learning'.")
