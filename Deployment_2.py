...
prediction_type = st.radio("Choose Prediction Type:", ("Sentiment Analysis", "Image Classification"))
...
if prediction_type == "Sentiment Analysis":
    ...
    st.write("Upload an image and choose a model (CNN or Transfer Learning) to classify the image.")
    ...
    if st.button("Predict Image"):
        if image_file is not None:
            ...
            if model_choice == "CNN":
                ...
                prediction = predict_image_class("temp_image.jpg", "transfer_learning")
